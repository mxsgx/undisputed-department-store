...
@section('body')
    <div class="p-4 flex grow flex-col items-center justify-center">
        <div class="flex flex-col items-center justify-center gap-8">
            ...
            <h3 class="text-6xl font-medium tracking-wide text-center text-gray-500">{{ __('This feature is under development') }}</h3>
        </div>
    </div>
@endsection
