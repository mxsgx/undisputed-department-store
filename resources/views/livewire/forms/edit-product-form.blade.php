...
{{ $description }}
        ...
        >
            <div class="w-full md:w-64 h-auto md:h-64 flex flex-col gap-2">
                @if ($image)
                    <img
            ...
            <label
                class="w-full h-64 p-4 bg-white text-gray-500 font-semibold text-base rounded flex flex-1 flex-col items-center justify-center cursor-pointer border-2 border-gray-300 border-dashed"
                for="image"
